(function(){
    ...
    const client_id = "88d7e3bddb8c7314840a";
    const client_secret = "a91b062595df261cbc2d7554a9484a3b0909075c";
    ...
    async function getUser(user){
        ...
        const reposResponse = await fetch(
            `${url}/${user}/repos?sort=updated&per_page=20&client_id=${client_id}&client_secret=${client_secret}`
        );
